...
export default function EditorGuard({ children, fallback }: EditorGuardProps) {
  const { user, isLoading, isAuthenticated, hasEditorAccess } = useAuth();
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span className="font-semibold">Administrator</span> atau{" "}
